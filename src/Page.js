...
import { getDeals, getTVL } from './gql';
...
debug('todayTimestamp', todayTimestamp);
const dayAgoTs = daysAgo(1);
debug('dayAgoTs', dayAgoTs);
const weekAgoTs = daysAgo(7);
debug('weekAgoTs', weekAgoTs);
const monthAgoTs = daysAgo(30);
debug('monthAgoTs', monthAgoTs);
...
const Page = () => {
  ...
  const loadMore = () => {
    debug('clicked on loadMore ', deals.length);
    fetchMore({
      variables: {
        skip: deals.length,
      },
          ...
          <div className="card e">
            ...
            <div className="table">
              <div className="row head">
                ...
                <div className="second column">Name</div>
                <div className="third column"># Requests</div>
              </div>
              {loading ? (
                tableLoader
                ...
                mostRequested.map(([appKey, appValue], index) => (
                  ...
                  >
                    ...
                    <div className="third column big">
                      <Loader
                        isLoading={loading}
                        width="80%"
          ...
          <div className="card f">
            ...
            <div className="table">
              <div className="row head">
                <div className="first column">ID</div>
                <div className="second column">Name</div>
                <div className="third column"># RLC Earned</div>
              </div>
              {loading ? (
                tableLoader
          ...
          <div className="card f">
            ...
            <div className="table compact">
              <div className="row head">
                ...
                <div className="third column">Status</div>
              </div>
              {loading ? (
                tableLoader
              ) : deals.length > 0 ? (
